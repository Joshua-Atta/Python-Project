...
def enter():
    ...
    lab = Label(frame1, text="CAR RENTAL SYSTEM",font=("ALGERIAN",20, 'bold')).pack()
    ...
    labf = Label(frame2, text="AVAILABLE CARS",font=("ALGERIAN",20, 'bold')).pack()
    ...
    def returncar():
        ...
        lab = Label(root1, text="RETURN CAR",font=("Algerian",20, 'bold')).pack()
        ...
        def rccar():
            ...
            con.commit()
            messagebox.showinfo("car returned", "thank you!")
            b1.delete(0, END)
            b2.delete(0, END)
            b3.delete(0, END)
    ...
    la = Label(frame3, text="RETURN CAR PORTAL",font=("Algerian",20, 'bold')).place(x=190, y=10)
...
a = StringVar()
b = StringVar()
t = Label(r, text="ADMIN LOGIN", font=("Algerian",20, 'bold')).pack()
user = Label(r, text="USERNAME",font=("Times new roman",8, 'bold')).place(x=150, y=150)
g = Entry(r, textvariable=a)
g.place(x=220, y=150)
passw = Label(r, text="PASSWORD", font=("Times new roman",8, 'bold')).place(x=150, y=180)
